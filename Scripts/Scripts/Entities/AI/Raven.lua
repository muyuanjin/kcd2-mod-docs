Raven = {
	ActionController = "Animations/Mannequin/ADB/kcd_raven_controllerdefs.xml",
	AnimDatabase3P = "Animations/Mannequin/ADB/kcd_raven_database.adb",

	UseMannequinAGState = true,

	defaultSoulArchetype = "Raven",
	defaultSoulClass = "raven",
	...
	Properties = {
		...
		fileModel = "Objects/Characters/animals/raven/raven.cdf",
...
EntityCommon.MakeSpawnable(Raven)